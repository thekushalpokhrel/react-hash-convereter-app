    ...
    return (
        <div className='hashing-container'>
            <div className='hashing-content'>
                ...
                <h4 className="hashing-form-heading">Kushal's Hash Converter App</h4>
                    <h4 className="hashing-form-heading">Convert Text/Files into Hash</h4>
                    <form>
                        <div className="form-group">
                            <label htmlFor="text-input">Your Text Here</label>
                            <input type="text" className="form-control" id="text-input" placeholder='eg: John Smith' value={text_input} onChange={handleTextInput} />
                        </div>
                        <div className="form-group">
                ...
                <div className="hashing-algorithms">
                    <h4 className="hashing-algorithms-heading">Choose Hash Algorithm</h4>
